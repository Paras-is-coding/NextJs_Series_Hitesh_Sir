...
export default function page() {
  ...
  // we've to inject which to watch
  const acceptMessages = watch('acceptMessages');

  // If there are chances of same data comming from function
  // we preserve the data resulting less no of calls 
...
// We can extract baseUrl with other ways as well
